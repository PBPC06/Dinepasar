...
from . import views
from search.views import get_foods,  edit_food, delete_food, add_food, fetch_foods, mark_food_as_tried, add_food_flutter, food_search_flutter, edit_food_flutter, delete_food_flutter, mark_food_flutter
app_name = "search"
...
urlpatterns = [
    ...
    path('mark_food_flutter/<uuid:id>/<int:food_id>/', mark_food_flutter, name='mark_food_flutter'),
